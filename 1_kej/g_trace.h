...
namespace cg
{
	...
	void __fastcall CG_TracePoint(vec3_t maxs, trace_t* trace, vec3_t start, vec3_t mins, vec3_t end, int entityNum, int contentMask, uint8_t unknw0, int8_t traceStaticModels);
