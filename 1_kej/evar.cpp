...
void Evar_Setup()
{
	...
	v::mod_autoFPS_space333.Register("1_kej_autofps_space333",			evartype_t::EVAR_BOOL,		(float)1);
	...
	v::mod_autoanglerpg.Register	("1_kej_autoanglerpg",				evartype_t::EVAR_BOOL,		(float)0);
